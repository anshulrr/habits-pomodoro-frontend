...
export const getPomodorosApi
    = (startDate, endDate, ic) => apiClient.get(`/pomodoros?startDate=${startDate}&endDate=${endDate}&include_categories=${ic}&timezone=${to}`)
...
export const getProjectsPomodorosApi
    = (startDate, endDate, ic) => apiClient.get(`/stats/projects-time?startDate=${startDate}&endDate=${endDate}&include_categories=${ic}&timezone=${to}`)
